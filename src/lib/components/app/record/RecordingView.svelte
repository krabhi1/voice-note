<script lang="ts">
	...
	// Initialize recording logic once wavesurfer is ready
	$effect(() => {
	...
	<div class="w-full max-w-3xl">
		<div class="mb-8 flex items-center justify-between border-b border-muted/30 pb-6 sm:mb-12 sm:pb-8">
			<div class="flex items-center gap-3 sm:gap-4">
				...
				<div>
					<span class="block text-[10px] font-bold uppercase tracking-wider text-secondary sm:text-xs">Session</span>
			...
			<div class="text-right">
				<span class="block text-[10px] font-bold uppercase tracking-wider text-secondary sm:text-xs">Elapsed</span>
		...
		<div class="relative mb-8 rounded-lg border border-muted bg-card p-6 shadow-xl shadow-muted/20 sm:mb-12 sm:p-10">
			<div class="h-32 w-full overflow-hidden sm:h-48">
				<AudioWaveform bind:wavesurfer mode="live" />
			</div>
